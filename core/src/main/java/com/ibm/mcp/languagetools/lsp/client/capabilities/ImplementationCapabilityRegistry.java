...
public class ImplementationCapabilityRegistry extends TextDocumentServerCapabilityRegistry<ImplementationRegistrationOptions> {
    ...
    static class ExtendedImplementationRegistrationOptions extends ImplementationRegistrationOptions implements ExtendedDocumentSelector.DocumentFilersProvider {
    ...
    @Override
    protected ImplementationRegistrationOptions create(JsonObject registerOptions) {
        return JsonUtils.getLsp4jGson().fromJson(registerOptions, ExtendedImplementationRegistrationOptions.class);
    }
